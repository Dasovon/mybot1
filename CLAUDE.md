...
|---|---|---|---|
| Power hat | RPI5 PD Power Hat P01 | DC barrel 9–24V → 5V/8A USB PD to Pi | Pi |
...
Common ground: Battery −, ESP32 GND, Pi GND (via hat), TB6612 GND, encoder GND — all one rail.
```
